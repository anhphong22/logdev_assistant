...
from logdev.utils import excel_to_string
...
def construct_index(
    ...
    if os.path.exists(f"./index/{index_name}.json"):
        logging.info("Found the cached index file, loading...")
        ...
        try:
            ...
            logging.debug("Constructed index successfully!")
            os.makedirs("./index", exist_ok=True)
            index.save_to_disk(f"./index/{index_name}.json")
            logging.debug("The index has been saved locally!")
            return index

        except Exception as e:
            logging.error("Index build failed!", e)
            print(e)
            return None
